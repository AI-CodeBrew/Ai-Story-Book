...
function LoginForm() {
  ...
  return (
    <div className="bg-void-texture flex min-h-screen items-center justify-center px-6 py-16">
      ...
      >
        <h1 className="font-display text-center text-2xl font-bold text-gradient-magic">Welcome back</h1>
        <p className="mt-1 text-center text-sm text-[var(--muted)]">Log in to create and save your stories.</p>
        ...
        <p className="mt-6 text-center text-sm text-[var(--muted)]">
          New here?{" "}
          <Link href="/signup" className="font-semibold text-[var(--gold)]">
            Create an account
          </Link>
        </p>
      </form>
